...
def report_trip_profitability(request):
    ...
    for trip in qs:
        ...
        split = apportion_trip_cost(trip)
        # freight_amount, not total_amount: total_amount includes GST, which is
        # collected on the government's behalf, not earned - matches project_lane
        # and Trip.settlement_summary. See docs/MULTIPOINT-FREIGHT.md §2.5.
